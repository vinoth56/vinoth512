Feature: Verify OMR Branch Cancel Booking Details
  ...
  Scenario Outline: Verify cancel booking Module by changing checkInDate for created order id
    ...
    Examples: 
      | username                | password       | SelectState | SelectCity | SelectRoomType | CheckIn    | CheckOut   | NoofRooms | NoofAdults | SelectSalutation | FirstName | LastName | MobileNo   | Email                   | EnterRegistrationNo | EnterCompanyName       | EnterCompanyAddress | SpecialRequest | cardType  | checkInDate |
      | sathish180699@gmail.com | Sathissurya18@ | Tamil Nadu  | Chennai    | Deluxe         | 2023-09-20 | 2023-09-30 | 1-One     | 2-Two      | Mr.              | Sathish   | S        | 9159611528 | sathish180699@gmail.com |          9043592058 | Greens Tech OMR Branch | Thoraipakkam        | LargeBed       | DebitCard | 2023-09-22  |
